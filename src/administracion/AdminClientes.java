...
/**
 * Servlet implementation class AdminClientes
 */
...
public class AdminClientes extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Solo se puede acceder a la p·gina si eres admin y del rol de clientes
		if(admin!=null && admin.getRol().equals("clientes")) {
			request.getRequestDispatcher("WEB-INF/AdminClientes.jsp").forward(request, response);
		} else {
